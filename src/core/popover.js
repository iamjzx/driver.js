...
export default class Popover extends Element {
  ...
  positionOnTopCenter(elementPosition) {
    ...
    this.node.style.top = `${elementPosition.top - popoverHeight - popoverMargin}px`;
    this.node.style.left = nodeCenter - popoverWidth - this.options.padding + dimensions.width > this.document.body.clientWidth ? '' : `${nodeCenter - popoverWidth - this.options.padding}px`;
    this.node.style.right = nodeCenter - popoverWidth - this.options.padding + dimensions.width > this.document.body.clientWidth ? '10px' : '';
    this.node.style.bottom = '';
  ...
  positionOnBottom(elementPosition) {
    ...
    this.node.style.left = (elementPosition.left - this.options.padding) + this.options.offset + popoverWidth > this.document.body.clientWidth ?  '' :  `${(elementPosition.left - this.options.padding) + this.options.offset}px`;
    this.node.style.right = (elementPosition.left - this.options.padding) + this.options.offset + popoverWidth > this.document.body.clientWidth ? '10px' : '';
    this.node.style.bottom = '';
    // 299 5 0
    console.log(this.document.body.clientWidth, (elementPosition.left - this.options.padding) + this.options.offset + popoverWidth) 
  ...
  positionOnBottomCenter(elementPosition) {
    ...
    this.node.style.top = `${elementPosition.bottom + popoverMargin}px`;
    this.node.style.left = popoverWidth > nodeCenter ? '10px' :`${nodeCenter - popoverWidth - this.options.padding}px`;
    this.node.style.right = '';
    this.node.style.bottom = '';
    console.log(nodeCenter, popoverWidth, this.options.padding)
    // Add the tip at the top center
  ...
  positionOnMidCenter(elementPosition) {
    ...
    const elementCenter = (elementPosition.bottom - elementPosition.top) / 2;
    // const topCenterPosition = (elementPosition.top - popoverCenter) + elementCenter + this.options.offset;
    const topCenterPosition = elementCenter + this.options.offset;
    const nodeCenter = this.options.offset + elementPosition.left + ((elementPosition.right - elementPosition.left) / 2);
    ...
    this.node.style.right = '';
    this.node.style.bottom = '';
    console.log(nodeCenter, popoverDimensions)
    // Add the tip at the top center
